...
def main():
    ...
    Equilibration_Steps = 200  # Equilibration Steps - Value to ignore the first X numbers from the traj file
    nbins = 76                 # Number of bins to be used while analyzing the trajectory
    tmax = 6                    # Default 6
    tmin = 2                    # Default 2
    ...
    Q_zero = 35                # Initial transition boundary
    Q_one = 450                # Final transition boundary
